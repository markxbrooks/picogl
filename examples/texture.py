...
class BasicObjectRenderer(RendererBase):
    ...
    def __init__(self, context):
        ...
        self.context.uv_data = to_float32_row(g_uv_buffer_data)
    ...
    def initialize_rendering_buffers(self):
        ...
        glBufferData(GL_ARRAY_BUFFER, len(g_vertex_buffer_data) * 4,
                     (GLfloat * len(g_vertex_buffer_data))(*g_vertex_buffer_data), GL_STATIC_DRAW)
        ...
        glBufferData(GL_ARRAY_BUFFER, len(g_uv_buffer_data) * 4, (GLfloat * len(g_uv_buffer_data))(*g_uv_buffer_data),
                     GL_STATIC_DRAW)
